...
export default function NotificationModal({
  ...
  return (
    <div className='fixed tablet:relative pc:relative inset-0 flex z-50'>
      <div className="relative w-full h-full tablet:right-0 pc:right-0 tablet:top-12px pc:top-12px tablet:absolute pc:absolute tablet:w-350px tablet:h-400px pc:w-350px pc:h-400px bg-red10 border border-1px rounded-10px overflow-y-auto">
